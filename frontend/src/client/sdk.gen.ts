...
/**
 * List All Ingredients Info
 */
export const listAllIngredientsInfoDrinksIngredientsGet = <ThrowOnError extends boolean = false>(options?: Options<ListAllIngredientsInfoDrinksIngredientsGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ListAllIngredientsInfoDrinksIngredientsGetResponses, unknown, ThrowOnError>({
        responseType: 'json',
