...
export type ListAllIngredientsInfoDrinksIngredientsGetData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/drinks/ingredients';
};

export type ListAllIngredientsInfoDrinksIngredientsGetResponses = {
    /**
     * Response List All Ingredients Info Drinks Ingredients Get
     * Successful Response
     */
    200: Array<ChooseIngredient>;
};

export type ListAllIngredientsInfoDrinksIngredientsGetResponse = ListAllIngredientsInfoDrinksIngredientsGetResponses[keyof ListAllIngredientsInfoDrinksIngredientsGetResponses];
